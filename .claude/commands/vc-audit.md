...
**`vc-audit` version matches `2026-06-21.4`**: proceed silently.
...
**Fetched version is older than `2026-06-21.4`**: proceed silently. (This can happen with CDN caching or a rollback — the local version is already newer.)
